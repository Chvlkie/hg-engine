...
const u16 UNUSED FormToSpeciesMapping[] =
{
    ...
    [SPECIES_ONIX_CRYSTAL - SPECIES_MEGA_START] = SPECIES_ONIX,
    [SPECIES_VOLTORB_OVERHEAT - SPECIES_MEGA_START] = SPECIES_VOLTORB,
    [SPECIES_ELECTRODE_OVERHEAT - SPECIES_MEGA_START] = SPECIES_ELECTRODE,
    [SPECIES_MAGIKARP_DEEPSEA - SPECIES_MEGA_START] = SPECIES_MAGIKARP,
    [SPECIES_GYARADOS_DEEPSEA - SPECIES_MEGA_START] = SPECIES_GYARADOS,
    [SPECIES_PIKACHU_SURFING - SPECIES_MEGA_START] = SPECIES_PIKACHU,
    [SPECIES_PIKACHU_FLYING - SPECIES_MEGA_START] = SPECIES_PIKACHU,
    [SPECIES_PIKACHU_SNOWMAN - SPECIES_MEGA_START] = SPECIES_PIKACHU,
    [SPECIES_PARASECT_GHOST - SPECIES_MEGA_START] = SPECIES_PARASECT,
};
