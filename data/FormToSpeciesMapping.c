...
const u16 UNUSED FormToSpeciesMapping[] =
{
    ...
    [SPECIES_ONIX - SPECIES_MEGA_START] = SPECIES_ONIX_CRYSTAL,
    [SPECIES_MAGIKARP - SPECIES_MEGA_START] = SPECIES_MAGIKARP_DEEPSEA,
    [SPECIES_GYARADOS - SPECIES_MEGA_START] = SPECIES_GYARADOS_DEEPSEA,
};
