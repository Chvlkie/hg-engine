...
#define MAX_PALDEAN_FORMS_NUM      (SPECIES_TERAPAGOS_STELLAR)

#define MAX_SPECIES_CANONICAL_FORM_NUM (SPECIES_TERAPAGOS_STELLAR)

#define SPECIES_VOLTORB_OVERHEAT   (MAX_SPECIES_CANONICAL_FORM_NUM + 1)
#define SPECIES_ELECTRODE_OVERHEAT (MAX_SPECIES_CANONICAL_FORM_NUM + 2)
#define SPECIES_ONIX_CRYSTAL       (MAX_SPECIES_CANONICAL_FORM_NUM + 3)
