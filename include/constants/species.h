...
// define your fakemons below like this
#define SPECIES_ONIX_CRYSTAL       (MAX_SPECIES_CANONICAL_FORM_NUM + 1)
#define SPECIES_VOLTORB_OVERHEAT   (MAX_SPECIES_CANONICAL_FORM_NUM + 2)
#define SPECIES_ELECTRODE_OVERHEAT (MAX_SPECIES_CANONICAL_FORM_NUM + 3)
#define SPECIES_MAGIKARP_DEEPSEA    (MAX_SPECIES_CANONICAL_FORM_NUM + 4)
#define SPECIES_GYARADOS_DEEPSEA   (MAX_SPECIES_CANONICAL_FORM_NUM + 5)
#define SPECIES_PIKACHU_SURFING    (MAX_SPECIES_CANONICAL_FORM_NUM + 6)
#define SPECIES_PIKACHU_FLYING      (MAX_SPECIES_CANONICAL_FORM_NUM + 7)
#define SPECIES_PIKACHU_SNOWMAN (MAX_SPECIES_CANONICAL_FORM_NUM + 8)
#define SPECIES_PARASECT_GHOST  (MAX_SPECIES_CANONICAL_FORM_NUM + 9)

#define MAX_NEW_FORM_NUM 9

#define MAX_SPECIES_INCLUDING_FORMS (MAX_SPECIES_CANONICAL_FORM_NUM + MAX_NEW_FORM_NUM)
