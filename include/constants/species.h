...
#define SPECIES_CUSTOM_START       (MAX_PALDEAN_FORMS_NUM + 1) 
#define SPECIES_VOLTORB_OVERHEAT (SPECIES_CUSTOM_START)
#define SPECIES_ELECTRODE_OVERHEAT (SPECIES_CUSTOM_START + 1)
#define SPECIES_ONIX_CRYSTAL (SPECIES_CUSTOM_START + 2)
#define SPECIES_MAGIKARP_DEEPSEA (SPECIES_CUSTOM_START + 3)
#define SPECIES_GYARADOS_DEEPSEA (SPECIES_CUSTOM_START + 4)
