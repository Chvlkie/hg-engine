...
#define SPECIES_PARASECT_GHOST      (MAX_SPECIES_CANONICAL_FORM_NUM + 6)
#define MAX_CUSTOM_FORMS			(6)

#define MAX_SPECIES_INCLUDING_FORMS (MAX_SPECIES_CANONICAL_FORM_NUM + MAX_CUSTOM_FORMS) // 1476
