...
#define MAX_CANONICAL_MON_NUM (SPECIES_PECHARUNT) // 1075
...
#define MAX_MEGA_NUM (SPECIES_MEGA_DIANCIE) //1123
...
#define MAX_PRIMAL_NUM (SPECIES_GROUDON_PRIMAL) //1125
...
#define MAX_ALOLAN_REGIONAL_NUM (SPECIES_KOMMO_O_LARGE) // 1155
...
#define MAX_GALARIAN_REGIONAL_NUM (SPECIES_STUNFISK_GALARIAN) // 1174
...
#define MAX_MISC_FORM_NUM (SPECIES_ENAMORUS_THERIAN) // 1325
...
#define MAX_HISUIAN_REGIONAL_NUM (SPECIES_AVALUGG_LORD) // 1346
...
#define MAX_SPECIES_SIGNIFICANT_GENDER_DIFFERENCE_NUM (SPECIES_BASCULEGION_FEMALE) // 1353
...
#define MAX_PALDEAN_FORMS_NUM (SPECIES_TERAPAGOS_STELLAR) // 1392

#define MAX_SPECIES_CANONICAL_FORM_NUM (SPECIES_TERAPAGOS_STELLAR)

#define SPECIES_CUSTOM_FORMS_START (MAX_SPECIES_CANONICAL_FORM_NUM + 1) // 1393

#define SPECIES_VOLTORB_OVERHEAT   (SPECIES_CUSTOM_FORMS_START)
#define SPECIES_ELECTRODE_OVERHEAT (SPECIES_CUSTOM_FORMS_START + 1)
#define SPECIES_ONIX_CRYSTAL       (SPECIES_CUSTOM_FORMS_START + 2)
#define SPECIES_MAGIKARP_DEEPSEA   (SPECIES_CUSTOM_FORMS_START + 3)
#define SPECIES_GYARADOS_DEEPSEA   (SPECIES_CUSTOM_FORMS_START + 4)

#define MAX_SPECIES_INCLUDING_FORMS (SPECIES_GYARADOS_DEEPSEA) // 1397
