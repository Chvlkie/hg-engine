...
#define MAX_SPECIES_CANONICAL_FORM_NUM (MAX_SPECIES_PALDEAN_FORM_NUM) //	1373

// define your fakemons below like this
// #define SPECIES_FAKEMON_FORM1 (MAX_SPECIES_CANONICAL_FORM_NUM + 1)

#define SPECIES_VOLTORB_OVERHEAT   (MAX_SPECIES_CANONICAL_FORM_NUM + 1) // 1379
#define SPECIES_ELECTRODE_OVERHEAT (MAX_SPECIES_CANONICAL_FORM_NUM + 2) // 1380
#define SPECIES_ONIX_CRYSTAL       (MAX_SPECIES_CANONICAL_FORM_NUM + 3) //	1381
#define SPECIES_MAGIKARP_DEEPSEA   (MAX_SPECIES_CANONICAL_FORM_NUM + 4) // 1382
#define SPECIES_GYARADOS_DEEPSEA   (MAX_SPECIES_CANONICAL_FORM_NUM + 5) // 1383

#define NUM_OF_FAKEMON_FORMS (5)
#define MAX_SPECIES_INCLUDING_FORMS (MAX_SPECIES_CANONICAL_FORM_NUM + NUM_OF_FAKEMON_FORMS)
