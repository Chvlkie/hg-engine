...
#define SPECIES_TERAPAGOS_STELLAR                 (SPECIES_PALDEAN_FORMS_START + 38) // 1372

#define MAX_SPECIES_PALDEAN_FORM_NUM (SPECIES_TERAPAGOS_STELLAR) // 1372	

#define MAX_SPECIES_CANONICAL_FORM_NUM (MAX_SPECIES_PALDEAN_FORM_NUM) // 1372

// define your fakemons below like this
// #define SPECIES_FAKEMON_FORM1 (MAX_SPECIES_CANONICAL_FORM_NUM + 1)
#define SPECIES_CUSTOM_FORMS_START (MAX_SPECIES_CANONICAL_FORM_NUM + 1) // 1373

#define SPECIES_VOLTORB_OVERHEAT   (SPECIES_CUSTOM_FORMS_START) // 1373
#define SPECIES_ELECTRODE_OVERHEAT (SPECIES_CUSTOM_FORMS_START + 1)
#define SPECIES_ONIX_CRYSTAL       (SPECIES_CUSTOM_FORMS_START + 2) // 1375
#define SPECIES_MAGIKARP_DEEPSEA   (SPECIES_CUSTOM_FORMS_START + 3) 
#define SPECIES_GYARADOS_DEEPSEA   (SPECIES_CUSTOM_FORMS_START + 4) 

#define MAX_SPECIES_INCLUDING_FORMS (SPECIES_GYARADOS_DEEPSEA)
