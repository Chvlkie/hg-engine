...
struct TrainerMoney PrizeMoney[] = // 0x34C04 in Overlay 12; 2 bytes for trainer class ID, 2 bytes for modifier; 516 bytes in total in vanilla
{
    ...
    { .class = TRAINERCLASS_PKMN_TRAINER_RED, .multiplier = 30 },
    ...
    { .class = TRAINERCLASS_TEAM_ROCKET_JESSIE_JAMES, .multiplier = 30 },
    { .class = TRAINERCLASS_TEAM_ROCKET_JESSIE, .multiplier = 30 },
    { .class = TRAINERCLASS_TEAM_ROCKET_JAMES, .multiplier = 30 },
