...
struct TrainerMoney PrizeMoney[] = // 0x34C04 in Overlay 12; 2 bytes for trainer class ID, 2 bytes for modifier; 516 bytes in total in vanilla
{
    ...
    { .class = TRAINERCLASS_LEADER_BROCK, .multiplier = 16 },
    ...
    { .class = TRAINERCLASS_LEADER_MISTY, .multiplier = 16 },
    ...
    { .class = TRAINERCLASS_LEADER_LT_SURGE, .multiplier = 15 },
    { .class = TRAINERCLASS_LEADER_ERIKA, .multiplier = 10 },
    { .class = TRAINERCLASS_LEADER_JANINE, .multiplier = 10 },
