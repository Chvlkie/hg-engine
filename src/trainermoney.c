...
struct TrainerMoney PrizeMoney[] = // 0x34C04 in Overlay 12; 2 bytes for trainer class ID, 2 bytes for modifier; 516 bytes in total in vanilla
{
   ...
   {.class = CLASS_PAINTER,          .multiplier = 8}, // Entry 13
   ...
   {.class = CLASS_TAMER,            .multiplier = 8}, // Entry 29
   ...
   {.class = CLASS_ROCKER,           .multiplier = 6}, // Entry 52
   ...
   {.class = CLASS_CUE_BALL,         .multiplier = 6}, // Entry 57
   {.class = CLASS_CLOWN,            .multiplier = 6}, // Entry 58
   {.class = CLASS_ENGINEER,         .multiplier = 6}, // Entry 59
   {.class = CLASS_ACE_DUO,          .multiplier = 20}, // Entry 60
   {.class = CLASS_BATTLE_KIN,       .multiplier = 20}, // Entry 61
   ...
   {.class = CLASS_LEADER_M,         .multiplier = 30}, // Entry 66 BROCK
   {.class = CLASS_LEADER_F,         .multiplier = 30}, // Entry 67 MISTY
   {.class = CLASS_POKE_MANIAC,      .multiplier = 16}, // Entry 68
   {.class = CLASS_BIRD_KEEPER_1,    .multiplier = 8}, // Entry 69 Johto Bird Keeper
   {.class = CLASS_LEADER,           .multiplier = 30}, // Entry 70 LT SURGE
   {.class = CLASS_RANCHER,          .multiplier = 10}, // Entry 71
   {.class = CLASS_LEADER_0,         .multiplier = 30}, // Entry 72 ERIKA
   {.class = CLASS_LEADER_1,         .multiplier = 30}, // Entry 73 KOGA
   {.class = CLASS_LEADER_2,         .multiplier = 30}, // Entry 74 SABRINA
   {.class = CLASS_LEADER_3,         .multiplier = 30}, // Entry 75 BLAINE
   {.class = CLASS_LEADER_4,         .multiplier = 30}, // Entry 76 GIOVANNI
   {.class = CLASS_SIS_AND_BRO,      .multiplier = 20}, // Entry 77
   {.class = CLASS_SUPER_NERD,       .multiplier = 12}, // Entry 78
   {.class = CLASS_GAMBLER,          .multiplier = 12}, // Entry 79
   ...
   {.class = CLASS_PKMN_TRAINER_RED, .multiplier = 16}, // Entry 103 Misty
   {.class = CLASS_PKMN_TRAINER_GREEN,.multiplier = 16}, // Entry 104 Lt. Surge
   {.class = CLASS_TEAM_ROCKET_JAMES,.multiplier = 10}, // Entry 105 Erika
   {.class = CLASS_TEAM_ROCKET_JESSIE,.multiplier = 10}, // Entry 106 Janine
   {.class = CLASS_LEADER_10,        .multiplier = 30}, // Entry 107 Sabrina
   {.class = CLASS_LEADER_11,        .multiplier = 30}, // Entry 108 Blaine
   {.class = CLASS_PKMN_TRAINER_ASH, .multiplier = 50}, // Entry 109 ASH
   {.class = CLASS_PKMN_TRAINER_YELLOW,.multiplier = 40}, // Entry 110 YELLOW
   ...
   {.class = CLASS_EXECUTIVE_1,      .multiplier = 30}, // Entry 117 ORION
   {.class = CLASS_EXECUTIVE_2,      .multiplier = 30}, // Entry 118 CONSTANTIN
   {.class = CLASS_PASSERBY,         .multiplier = 25}, // Entry 119
   {.class = CLASS_MYSTERY_MAN,      .multiplier = 35}, // Entry 120 
   ...
   {.class = CLASS_ROCKET_BOSS,      .multiplier = 20}, // Entry 124 Giovanni
