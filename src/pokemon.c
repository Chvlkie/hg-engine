...
const u8 sTrainerGenders[] = {
    ...
    [TRAINERCLASS_COWGIRL] = TRAINER_MALE,
    ...
    [TRAINERCLASS_LEADER_WHITNEY] = TRAINER_MALE,
    [TRAINERCLASS_RANCHER] = TRAINER_MALE,
    [TRAINERCLASS_LEADER_MORTY] = TRAINER_FEMALE,
    [TRAINERCLASS_LEADER_PRYCE] = TRAINER_MALE,
    [TRAINERCLASS_LEADER_JASMINE] = TRAINER_MALE,
    [TRAINERCLASS_LEADER_CHUCK] = TRAINER_FEMALE,
    [TRAINERCLASS_LEADER_CLAIR] = TRAINER_MALE,
    ...
    [TRAINERCLASS_ELITE_FOUR_KAREN] = TRAINER_MALE,
    ...
    [TRAINERCLASS_LEADER_JANINE] = TRAINER_MALE,
    ...
    [TRAINERCLASS_ELITE_FOUR_BRUNO] = TRAINER_MALE,
    ...
    [TRAINERCLASS_EXECUTIVE_PETREL] = TRAINER_FEMALE,
