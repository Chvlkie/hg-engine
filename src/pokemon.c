...
const u8 sTrainerGenders[] = {
    [TRAINERCLASS_PLAYER_M] = TRAINER_MALE,
    [TRAINERCLASS_PLAYER_F] = TRAINER_FEMALE,
    ...
    [TRAINERCLASS_ENGINEER] = TRAINER_MALE,
    ...
    [TRAINERCLASS_LEADER_LT_SURGE] = TRAINER_FEMALE,
    [TRAINERCLASS_RANCHER] = TRAINER_MALE,
    [TRAINERCLASS_LEADER_ERIKA] = TRAINER_MALE,
    [TRAINERCLASS_LEADER_BLAINE] = TRAINER_MALE,
    [TRAINERCLASS_LEADER_KOGA] = TRAINER_FEMALE,
    [TRAINERCLASS_LEADER_SABRINA] = TRAINER_MALE,
    [TRAINERCLASS_LEADER_GIOVANNI] = TRAINER_FEMALE,
    [TRAINERCLASS_TEACHER] = TRAINER_FEMALE,
    [TRAINERCLASS_SUPER_NERD] = TRAINER_MALE,
    [TRAINERCLASS_GAMBLER] = TRAINER_MALE,
    ...
    [TRAINERCLASS_TEAM_ROCKET_JESSIE_JAMES] = TRAINER_MALE,
    [TRAINERCLASS_TEAM_ROCKET_JESSIE] = TRAINER_FEMALE,
    [TRAINERCLASS_TEAM_ROCKET_JAMES] = TRAINER_FEMALE,
    [TRAINERCLASS_LEADER_14] = TRAINER_FEMALE,
    [TRAINERCLASS_LEADER_15] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_TBC] = TRAINER_MALE,
    [TRAINERCLASS_LEADER_16] = TRAINER_MALE,
    [TRAINERCLASS_ELDER] = TRAINER_MALE,
    [TRAINERCLASS_ELITE_FOUR_LANCE] = TRAINER_FEMALE,
    ...
    [TRAINERCLASS_EXECUTIVE_ORION] = TRAINER_MALE,
    [TRAINERCLASS_EXECUTIVE_MARGOT] = TRAINER_MALE,
